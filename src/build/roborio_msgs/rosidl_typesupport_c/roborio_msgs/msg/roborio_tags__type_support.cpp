...
static const _RoborioTags_type_support_symbol_names_t _RoborioTags_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roborio_msgs, msg, RoborioTags)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roborio_msgs, msg, RoborioTags)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, roborio_msgs, msg, RoborioTags)() {
  return &::roborio_msgs::msg::rosidl_typesupport_c::RoborioTags_message_type_support_handle;
}
